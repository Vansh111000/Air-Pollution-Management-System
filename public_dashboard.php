...
<!-- WAQI Real-time AQI Map Integration -->
<script src="assets/js/waqiMap.js"></script>
...
// Store map globally so waqiMap.js can access it
window._vayuMap = map;
...
// ══════════════════════════════════════
// WAQI REAL-TIME AQI TILE LAYER INIT
// Initialised here so it runs after the map and all helpers are ready
// ══════════════════════════════════════
initWaqiTileLayer(map);
</script>
</body>
</html>